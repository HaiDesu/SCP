	...
	<div class="col-lg-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">Create a New Series Type</h3>
			</div>
			<div class="panel-body">
				<?=$this->getContent();?>
				<form action="/series_types/create" class="form-horizontal" method="post" accept-charset="utf-8">
					<div class="form-group">
						<label for="name" class="col-sm-2 control-label">Name</label>
						<div class="col-sm-8">
							<?php echo $this->tag->textField(array("name", 'maxlength' => 16, 'class' => 'form-control', 'placeholder' => 'Series Type Name')) ?>
