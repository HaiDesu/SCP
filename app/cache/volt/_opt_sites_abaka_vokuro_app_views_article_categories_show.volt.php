<div class="row">
	<div class="col-lg-6">
		<ol class="breadcrumb">
		  ...
		  <li><a href="/article_categories"><span class="icon-bookmark"></span> Categories</a></li>
...
<div class="row">
	<div class="col-lg-6">
		<h3><?=$category->name;?> <a href="/article_categories/edit/<?=$category->id;?>" class="btn btn-default btn-sm"><span class="icon-pencil"></span> Edit</a> <a data-toggle="modal" data-target="#deleteConfirm" class="btn btn-danger btn-xs"><span class="icon-hammer-2"></span></a></h3>
