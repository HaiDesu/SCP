<div class="row">
	<div class="col-lg-6">
		<ol class="breadcrumb">
		  ...
		  <li class="active"><span class="icon-plus"></span> New Series</li>
		</ol>
	</div>
	...
	<div class="col-lg-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">Add New Series</h3>
			</div>
			<div class="panel-body">
				<?=$this->getContent();?>
				<form action="/series/create" class="form-horizontal" method="post" accept-charset="utf-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<span class="help-block"><em>Paste as plain text only. Japanese as well as English titles, separated by a colon ;</em></span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<?php echo $this->tag->textField(array("episodes", 'type' => 'number', 'class' => 'form-control', 'placeholder' => '# of Episodes')) ?>
						...
						<div class="col-sm-10">
							<ul class="list-unstyled">
								...
								<li style="display:inline-block;width:25%;">
									<input type="checkbox" name="genres[]" value="<?=$genre->id;?>"/> <label for="genres" class="no-weight"><?=$genre->name;?></label>
								</li>
								<?php } ?>
							<ul>
						</div>
