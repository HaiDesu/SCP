...
<div class="row">
	<div class="col-lg-6">
		<h3><?=$stype->name;?> <a href="/stypes/edit/<?=$stype->id;?>" class="btn btn-default btn-sm"><span class="icon-pencil"></span> Edit</a> <a data-toggle="modal" data-target="#deleteConfirm" class="btn btn-danger btn-xs"><span class="icon-hammer-2"></span></a></h3>
